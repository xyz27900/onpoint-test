...
const PulseCircle = ({ x, y, min, max }) => {
	return <Svg x={x} y={y} width={100} height={100} viewBox={'0 0 100 100'}>
		...
		<Circle id={0} x={50} y={50} radius={[min, max]} stroke={`url(#${strokeGradientId})`} fill={fillColor} strokeWidth={1} opacity={.22} />
		<Circle id={1} x={50} y={50} radius={[min, max]} stroke={`url(#${strokeGradientId})`} fill={fillColor} strokeWidth={1} opacity={0} />
		<Circle id={2} x={50} y={50} radius={[min, max]} stroke={`url(#${strokeGradientId})`} fill={fillColor} strokeWidth={1} opacity={0} />
		<Circle id={3} x={50} y={50} radius={[min, max]} stroke={`url(#${strokeGradientId})`} fill={fillColor} strokeWidth={1} opacity={0} />
	</Svg>;
};
